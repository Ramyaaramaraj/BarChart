...
class DrawBar extends View {
    ...
    Paint Bar=new Paint();
    public DrawBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    Bar_Chart_details cvalues;
    public  void setvalues(Bar_Chart_details cd) {
        cvalues =cd;
        postInvalidate();
    }
    @Override
